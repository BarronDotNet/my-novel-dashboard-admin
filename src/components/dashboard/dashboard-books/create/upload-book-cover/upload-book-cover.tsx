...
const UploadBookCover = ({ bookCover }: UploadBookCoverProps) => {
  ...
  return (
    <div className="relative">
      ...
      <label
        className="relative flex cursor-pointer appearance-none justify-center rounded-md border border-dashed border-gray-300 bg-white p-1 text-sm transition hover:border-gray-400 focus-within:border-blue-600 focus-within:ring-1 focus-within:ring-blue-600"
        tabIndex={0}
      >
        {imagePreview ? (
